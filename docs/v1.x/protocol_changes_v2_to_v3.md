...
### tcp_sensor_simulator.py (removed) → simulators/tcp_sensor_simulator_v3.py
...
**New (V3):**
```bash
python3 simulators/tcp_sensor_simulator_v3.py --host 127.0.0.1 --port 9001 --loc-id "room1" --log-file logs/sim.log
