...
|-----------|------|--------|-------------|
| TCP Sensor Simulator | `simulators/tcp_sensor_simulator_v3.py` | ✅ Ready | Generates 32×24 thermal frames + ADC sensor data |
...
python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --interval 1.0
...
python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --loc-id "Bug Test"
...
### Quick Reference
- **Start Simulator**: `python3 simulators/tcp_sensor_simulator_v3.py --port 9001`
