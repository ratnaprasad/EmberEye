...
### 1. **TCP Sensor Simulator** (`simulators/tcp_sensor_simulator_v3.py`)
...
python3 simulators/tcp_sensor_simulator_v3.py --port 9001

# Multiple simulators with different locations
python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --loc-id "room_1" --interval 1.0
python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --loc-id "room_2" --interval 1.5

# Test embedded format
python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --format embedded

# Test continuous hex format
python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --format continuous
```
...
### ✅ Simulator Support
- `simulators/tcp_sensor_simulator_v3.py` generates 32×24 thermal frames compatible with:
...
python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --loc-id "Test Room" --interval 1.0
```
...
python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --loc-id "room_1" --interval 0.5

# Terminal 2: Room 2 (normal updates)
python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --loc-id "room_2" --interval 2.0

# Terminal 3: Room 3 (slow updates)
python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --loc-id "room_3" --interval 5.0
```
...
for format in separate embedded continuous no_loc; do
   ...
   timeout 10 python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --format $format --loc-id "test_$format"
    sleep 2
done
```
...
python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --interval 0.067 --loc-id "high_fps_cam"
