...
### Simulators
- **`simulators/tcp_sensor_simulator_v3.py`** - Thermal camera & gas sensor simulator
  - Generates 32×24 thermal frames with hot spots
  - Emulates ADC sensor readings
  - Supports multiple packet formats
  - Auto-reconnect on disconnect

- **`simulators/tcp_simulator.py`** - Deprecated shim (forwards to simulators/tcp_sensor_simulator_v3.py)
...
2. Run the simulator: `python3 simulators/tcp_sensor_simulator_v3.py --port 9001`
...
### Testing Tools
```
simulators/tcp_sensor_simulator_v3.py          - Thermal sensor simulator
