...
### 4. Simulator V3 (`simulators/tcp_sensor_simulator_v3.py`)
...
python3 simulators/tcp_sensor_simulator_v3.py --host 127.0.0.1 --port 9001 --loc-id "test room" --interval 2.0
```
