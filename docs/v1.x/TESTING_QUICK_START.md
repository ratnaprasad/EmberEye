...
```bash
# Terminal 2
python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --loc-id "Test Room" --interval 2.0
```
...
timeout 10 python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --format separate --loc-id "test_sep" || true

# Test 2: Embedded format (loc_id in prefix)
timeout 10 python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --format embedded --loc-id "test_emb" || true

# Test 3: Continuous hex (no spaces)
timeout 10 python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --format continuous --loc-id "test_cont" || true

# Test 4: No loc_id (IP fallback)
timeout 10 python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --format no_loc || true
```
...
python3 simulators/tcp_sensor_simulator_v3.py --port 9001 --interval 0.5 &
