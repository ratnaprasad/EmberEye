...
1. Stop the simulator: `pkill -f simulators/tcp_sensor_simulator_v3.py`
...
3. Restart simulator: `python simulators/tcp_sensor_simulator_v3.py --host 127.0.0.1 --port 9001 --loc-id cam01`
