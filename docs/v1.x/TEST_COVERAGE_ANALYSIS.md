...
#### 12. Vision Detector ✗
- **Module:** `embereye_base/core/vision_detector.py`
- **Coverage:** ~0%
- **Tests:** None
- **Not Covered:**
...
- **Module:** `embereye_base/app/thermal_grid_config.py`
- **Coverage:** ~0%
- **Tests:** None
- **Not Covered:**
  - Settings dialog
...
#### 21. User Creation ✗
- **Module:** `embereye_base/app/user_creation.py`
- **Coverage:** ~0%
...
- **File:** `simulators/tcp_sensor_simulator_v3.py`
