...
**Updated:** `simulators/tcp_sensor_simulator_v3.py`
...
**Usage:**
```bash
python simulators/tcp_sensor_simulator_v3.py --format separate --loc-id "room1"
python simulators/tcp_sensor_simulator_v3.py --format embedded --loc-id "123"
python simulators/tcp_sensor_simulator_v3.py --format continuous --loc-id "lab"
python simulators/tcp_sensor_simulator_v3.py --format no_loc
```
...
## Files Modified
- `simulators/tcp_sensor_simulator_v3.py` - Added 4 format support
