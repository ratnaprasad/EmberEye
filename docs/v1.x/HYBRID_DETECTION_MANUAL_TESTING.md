...
### 1. Test Script: `tests/test_hybrid_detection_video.py`
A standalone Python script that processes `simulators/rtsp/data/IMG_1318.MOV` and separates frames:

**Location**: `d:\EE\EmberEye\tests/test_hybrid_detection_video.py`
...
```powershell
cd 'd:\EE\EmberEye'
& "D:\EE\EmberEye\.venv\Scripts\python.exe" tests/test_hybrid_detection_video.py
```
...
| File | Purpose |
|------|---------|
| `tests/test_hybrid_detection_video.py` | Test script for manual verification |
