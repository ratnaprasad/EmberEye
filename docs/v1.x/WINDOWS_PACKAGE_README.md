...
- TCP sensor simulator (`simulators/tcp_sensor_simulator_v3.py`)
...
python simulators/tcp_sensor_simulator_v3.py --port 9001 --loc-id "Test Room"
```
...
python simulators/tcp_sensor_simulator_v3.py --port 9001 --interval 1.0
...
- **simulators/tcp_sensor_simulator_v3.py** - Hardware simulator for testing

### Run Commands
```powershell
python main.py                                    # Start application
python simulators/tcp_sensor_simulator_v3.py --port 9001        # Start simulator
