...
### 2. `simulators/tcp_sensor_simulator_v3.py`
Updated simulator generates frames in correct format with realistic thermal data.

**Start Simulator:**
```bash
python simulators/tcp_sensor_simulator_v3.py --port 4888 --loc-id cam01 --interval 0.5
```
...
- ✅ `simulators/tcp_sensor_simulator_v3.py` - Updated: 834-word frame generation
