...
# Keep stream_config.json at repository root while this module lives under embereye_base/core/thermal.
ROOT_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', '..'))
STREAM_CFG = os.path.join(ROOT_DIR, 'stream_config.json')
