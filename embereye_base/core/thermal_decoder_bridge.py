...
try:
    ...
    from embereye_base.core.thermal.process_rawdata import MLX90640Direct as ThermalRuntimeProcessor
except Exception:
    try:
        ...
        try:
            from embereye_base.core.thermal.mlx90640_fogleman_offline import MLX90640FoglemanOffline as ThermalRuntimeProcessor
        except Exception:
